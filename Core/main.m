...
stateCal1 = StateCalculator(iHandler, pHandler, 'AHRS', Utils.AHRS_EKF, 'Aligner', Utils.AHRS_MADGWICK,'Position', Utils.VERTICAL_POSITION, 'ZUP_noiseW',0.01,'ZUP_noiseF', 1000, 'ZUP_noiseV', 200,'ZUP_noiseG', 250,'ZUP_noiseM', 170,'EKF_noiseF', 30,'EKF_noiseM', 50,'EKF_noiseW', 0.4);
...
Plotter.displayResults(stateCal1,"types"," Gait AccRaw AccENU Angularvel");
